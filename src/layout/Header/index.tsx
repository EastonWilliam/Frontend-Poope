...
import { ColorButton, DropdownLanguageButton, LogoButton, WalletLoginButton } from '@/components/Buttons/Buttons'
import { MenuOutlined } from '@mui/icons-material'
import { Box, ButtonBase, Container, Link, Stack, Theme } from '@mui/material'
import { styled } from '@mui/material/styles'

import TransitionModal from '@/components/WalletConnect'
...
const Header = () => {
  ...
  const Modal = TransitionModal as any
  return (
    <Box
      component='header'
      sx={{
    ...
    >
      <Modal open={walletOpen} handleClose={() => setWalletOpen(false)} />
      <Container
        maxWidth='xl'
        sx={{
      ...
      >
        ...
        >
          ...
          {/* navigation */}
          <Navbar>
            {['About', 'Tokenomics', 'Roadmap', 'Community', 'FAQ'].map(item => (
              <Link
            ...
            <DropdownLanguageButton
              ...
              borderColor='white'
              icon={[
                <img src='../assets/icons/en.png' width={'24px'} />,
                <img src='../assets/icons/en.png' width={'24px'} />,
                <img src='../assets/icons/en.png' width={'24px'} />
              ]}
            />
          ...
          >
            ...
            >
              <ButtonBase color='primary' onClick={() => setMoblieHeaderOpen(true)}>
                <Stack
                  width='40px'
                  height='40px'
                  sx={{
